...
/**
 * CARRIERA AI START - WELCOME PAGE (LATO RICEVENTE REGALO)
 * * Style: Matches "Ai Team Gift Box" & "Carriera Premium" (Dark #020817, Gold #D4AF37)
 * * Content: Start Package specific copy provided by user.
 */

const CarrieraAIStart = () => {
                        ...
                        <div className="w-32 md:w-40 transition-all">
                            {!imgError ? (
                                ...
                                <div className="flex flex-col leading-none">
                                    ...
                                    <span className="text-[10px] text-[#D4AF37] tracking-[0.3em] uppercase font-bold">Carriera Start</span>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
                        ...
                        <p className="font-opensans text-lg md:text-xl text-slate-400 mb-10 max-w-3xl mx-auto leading-relaxed">
                            Hai ricevuto <strong>Carriera AI Start</strong>: l'accesso esclusivo a tecnologie AI, formazione d'élite e consulenti umani dedicati al tuo successo.
                        </p>
            ...
            <section className="py-24 bg-[#020617] relative border-t border-[#D4AF37]/10">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-20">
                        <h2 className="font-montserrat font-bold text-3xl md:text-4xl text-white mb-6">Cosa Contiene il Tuo Pacchetto Start?</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                        ...
                        <div className="group relative bg-[#0f172a]/60 border border-[#D4AF37]/30 rounded-3xl p-8 hover:bg-[#0f172a]/80 transition-all duration-300">
                            ...
                            <h3 className="font-montserrat font-bold text-xl text-white mb-2">2 Consulenze di Carriera 1-1</h3>
                            <p className="font-opensans text-slate-400 text-sm leading-relaxed mb-4">
                                Sessioni private con esperti reali. Ti aiuteremo a individuare la tua CArriera ideale nella nuova era dell’intelligenza artificiale.
                            </p>
                        </div>
                        ...
                        {/* ITEM 3: AI TEAM EXPERIENCE (1 Biglietto) */}
                        <div className="group relative bg-gradient-to-br from-[#D4AF37]/10 to-[#0f172a] border border-[#D4AF37]/40 rounded-3xl p-8 md:col-span-2 lg:col-span-1">
                            <div className="absolute top-4 right-4 bg-[#D4AF37]/20 text-[#D4AF37] text-xs font-bold px-3 py-1 rounded border border-[#D4AF37]/30 uppercase">
                                Evento Live
                            </div>
                            <div className="w-16 h-16 bg-[#D4AF37] rounded-2xl flex items-center justify-center text-black mb-6 shadow-[0_0_20px_rgba(212,175,55,0.4)]">
                                <Star size={32} fill="currentColor" />
                            </div>
                            <h3 className="font-montserrat font-bold text-xl text-white mb-2">AI Team Experience (1 Biglietto)</h3>
                            <p className="font-opensans text-slate-300 text-sm leading-relaxed mb-4">
                                Partecipa a un evento formativo in diretta online di 3 serate con Luca Papa e il suo AI Team. Vivi l'esperienza di gestire un team di AI Agents che lavora per te.
                            </p>
                            <div className="flex flex-wrap gap-2 text-xs font-bold text-[#D4AF37] uppercase tracking-wider mt-4">
                                <span className="flex items-center gap-1"><CheckCircle2 size={12} /> Networking</span>
                                <span className="flex items-center gap-1"><CheckCircle2 size={12} /> Live</span>
                                <span className="flex items-center gap-1"><CheckCircle2 size={12} /> Strategia</span>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="space-y-8 sticky top-32">
                            ...
                            <p className="font-opensans text-lg text-slate-300 leading-relaxed">
                                Il tuo pacchetto <strong>Carriera AI Start</strong> include una sessione privata di onboarding.
                                Ti guideremo attraverso la piattaforma, configureremo le tue credenziali e ti consegneremo le chiavi del veicolo con cui iniziare il tuo viaggio verso l’era dell’intelligenza artificiale.
                            </p>
...
export default CarrieraAIStart;
