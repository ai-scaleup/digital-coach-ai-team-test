...
/**
 * BUSINESS AI START - WELCOME PAGE (LATO RICEVENTE REGALO)
 * * Style: Matches "Ai Team Gift Box" (Dark #020817, Gold #D4AF37)
 * * Content: Updated with specific Business START Copy (5 Agents, 3 Days, 2 Consultations).
 */

const BusinessAIStart = () => {
                        ...
                        <div className="w-32 md:w-40 transition-all">
                            {!imgError ? (
                                ...
                                <div className="flex flex-col leading-none">
                                    ...
                                    <span className="text-[10px] text-[#D4AF37] tracking-[0.3em] uppercase font-bold">Business Start</span>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
                        ...
                        <div className="relative w-full max-w-4xl mb-10 group animate-in fade-in zoom-in duration-700">
                            ...
                            />
                            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black/60 backdrop-blur-md px-6 py-2 rounded-full border border-[#D4AF37]/30 text-[#D4AF37] text-xs md:text-sm uppercase tracking-widest font-bold hidden md:block shadow-lg whitespace-nowrap">
                        ...
                        <p className="font-opensans text-lg md:text-xl text-slate-400 mb-10 max-w-3xl mx-auto leading-relaxed">
                            Hai ricevuto <strong>Business AI Start</strong>: l'accesso esclusivo a una forza lavoro di AI Agents, consulenza strategica d'élite e formazione per imprenditori visionari.
                        </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                        ...
                        <div className="group relative bg-[#0f172a]/60 border border-[#D4AF37]/30 rounded-3xl p-8 hover:bg-[#0f172a]/80 transition-all duration-300 hover:shadow-[0_0_30px_rgba(212,175,55,0.1)] md:col-span-2 lg:col-span-2">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start">
                                ...
                                <div>
                                    <h3 className="font-montserrat font-bold text-xl text-white mb-2">5 Agenti AI & Marketing Manager</h3>
                                    <p className="font-opensans text-slate-400 text-sm leading-relaxed mb-4">
                                        Accesso completo a un team di 5 specialisti AI tra cui il tuo Marketing Manager (Mike AI) con cui Potrai delegare strategie, copy, social, e sales 24/7 senza costi di personale aggiuntivi.
                                    </p>
                                    <div className="bg-[#020617]/50 rounded-xl p-4 border border-slate-700/50">
                                        <p className="text-xs text-slate-300 leading-relaxed font-medium">
                                            <strong className="text-[#D4AF37]">La tua Squadra:</strong> Aladino AI (Innovazione), Mike AI (Marketing Mgr), Daniele AI (Copy), Lara AI (SMM), Alex AI (Ads).
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="group relative bg-[#0f172a]/60 border border-[#D4AF37]/30 rounded-3xl p-8 hover:bg-[#0f172a]/80 transition-all duration-300">
                            ...
                            <h3 className="font-montserrat font-bold text-xl text-white mb-2">2 Consulenze Business 1-1</h3>
                            <p className="font-opensans text-slate-400 text-sm leading-relaxed mb-4">
                                Un nostro esperto umano farà sessioni 1-to-1 durante le quali dopo aver analizzato la tua attività, ti spiegherà come l’ AI può nel tuo specifico caso aiutarti e quali sono le applicazioni AI di maggiore impatto.
                            </p>
                        </div>

                        {/* ITEM 4: AI TEAM EXPERIENCE (1 Biglietto) */}
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start">
                                ...
                                <div>
                                    <h3 className="font-montserrat font-bold text-xl text-white mb-2 flex items-center gap-3">
                                        AI Team Experience (1 Biglietto)
                                    ...
                                    <p className="font-opensans text-slate-300 text-sm leading-relaxed mb-4">
                                        Un evento formativo di Luca Papa ed il suo Ai Team, in diretta Online di 3 serate. Con il pacchetto Start hai <strong>1 biglietto</strong> per vivere l'esperienza di dirigere un'azienda potenziata dall'IA.
                                    </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="space-y-8 sticky top-32">
                            ...
                            <p className="font-opensans text-lg text-slate-300 leading-relaxed">
                                Il tuo pacchetto <strong>Business AI Start</strong> include una sessione prioritaria di onboarding.
...
export default BusinessAIStart;
