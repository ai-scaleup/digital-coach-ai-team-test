...
export default function App() {
  ...
  const N8N_ENDPOINT = process.env.NEXT_PUBLIC_TEST_ALADINO_AI_N8N_ENDPOINT || "https://n8n-c2lq.onrender.com/webhook/d601660e-0387-406d-b314-3db2b503708e/chat?action=sendMessage"
                ...
                >
                  {msg.sender === "ai" && (
                    <div className="w-9 h-9 md:w-10 md:h-10 rounded-full shadow-lg shadow-sky-500/30 shrink-0 border-2 border-white dark:border-slate-900 overflow-hidden">
                      <img
                        src={currentAgent.image || "/assets/agents/Aladdin-AI-consultant.png"}
                        alt={currentAgent.name}
                        className="w-full h-full object-cover"
                      />
                    </div>
